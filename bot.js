 ...
 * Mini App (GRM FLAP). This is the "Telegram Bot -> Mini App" arrow.
 *
 * Setup:
...
bot.onText(/\/start/, (msg) => {
  bot.sendMessage(msg.chat.id, 'Welcome to GRM FLAP! Tap to keep the coin flying, climb the weekly leaderboard, and win GRM. 🪙', {
    reply_markup: {
      inline_keyboard: [[
